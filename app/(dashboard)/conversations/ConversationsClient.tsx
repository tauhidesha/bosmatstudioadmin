...
import { useRealtimeConversations, Conversation } from '@/lib/hooks/useRealtimeConversations';
...
function ConversationsContent({ initialConversations }: { initialConversations?: Conversation[] }) {
  ...
  const filteredConversations = conversations.filter(c => {
    ...
    return (
      ...
      (c.customerPhone && c.customerPhone.toLowerCase().includes(lowerQuery)) ||
            ...
            <div className="hidden md:flex flex-1 flex-col items-center justify-center bg-[#131313] relative overflow-hidden">
              ...
              <div className="text-center relative z-10">
                ...
                <p className="text-slate-500 font-sans text-xs uppercase tracking-widest font-bold">
                  {filteredConversations.length} total percakapan tersedia
                </p>
                {notificationCount > 0 && (
