  ...
  <table style="width:100%; border-collapse:collapse; background:#131313;">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:1px; background:#484831; margin-bottom:30px">
      <div class="bg-dark" style="padding:20px">
        <p class="text-yellow" style="font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:0.2em; margin-bottom:16px">Informasi Pelanggan</p>
        <p class="font-headline" style="font-size:20px; font-weight:700; text-transform:uppercase; margin-bottom:6px">${customerName || '-'}</p>
      ...
      <div class="bg-dark" style="padding:20px">
        <p class="text-yellow" style="font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:0.2em; margin-bottom:16px">Studio Layanan</p>
        <p class="font-headline" style="font-size:20px; font-weight:700; text-transform:uppercase; margin-bottom:6px">${studioMetadata.name.toUpperCase()}</p>
        <p class="text-muted" style="font-size:13px; line-height:1.6">
    ...
    <div class="totals-section" style="display:grid; grid-template-columns:7fr 5fr; gap:32px; margin-top:24px">
      <div>
        ${notesList.length > 0 ? `
        <div class="bg-darker border-yellow" style="padding:24px; margin-bottom:16px">
      ...
      <div style="background:#2a2a2a; padding:32px; display:flex; flex-direction:column; gap:16px">
        ...
        <div style="background:#FFFF00; padding:16px 20px; margin:0 -32px -32px; display:flex; justify-content:space-between; align-items:center">
          <div>
